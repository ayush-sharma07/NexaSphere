...
const StatCard = ({ title, value, color, icon }) => (
  <div style={{
    ...
    <div style={{
      marginTop: '8px', width: '8px', height: '8px',
...
export default function RealTimeDashboard() {
  ...
  const exportCSV = useCallback(() => {
    const rows = [
      ...
      ...Object.entries(eventData).map(([name, d]) => [name, d.registrations, d.attendees, d.checkIns]),
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
        <div>
          ...
          <p style={{ margin: '4px 0 0', color: '#666', fontSize: '14px' }}>NexaSphere Event Dashboard</p>
        </div>
      ...
      <div style={{ display: 'flex', gap: '16px', marginBottom: '32px', flexWrap: 'wrap' }}>
        <StatCard title="Total Registrations" value={stats.registrations} color="#e63946" icon="📝" />
      ...
      <div style={{
        ...
        padding: '24px', marginBottom: '24px', border: '1px solid #ffffff11'
      }}>
        <h2 style={{ margin: '0 0 20px', fontSize: '16px', color: '#ccc' }}>📈 Live Registration Trend</h2>
        <ResponsiveContainer width="100%" height={250}>
          <LineChart data={trendData}>
            ...
            <Legend />
            <Line type="monotone" dataKey="registrations" stroke="#e63946" strokeWidth={2} dot={false} />
      ...
      <div style={{
        background: 'rgba(255,255,255,0.03)', borderRadius: '12px',
        padding: '24px', border: '1px solid #ffffff11'
      }}>
        <h2 style={{ margin: '0 0 20px', fontSize: '16px', color: '#ccc' }}>🎯 Per-Event Breakdown</h2>
        <ResponsiveContainer width="100%" height={250}>
